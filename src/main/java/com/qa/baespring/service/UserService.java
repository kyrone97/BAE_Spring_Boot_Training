...
import com.qa.baespring.exception.UserNotFoundException;
import com.qa.baespring.exception.UserNotUpdatedException;
...
public class UserService {
	...
	public User update(long id, User myUser) {
		User existing = repo.findById(id).orElseThrow(UserNotUpdatedException::new); // get the existing user
